const int Kp = 0.7;   // Kp value that you have to change
const int Kd = 0.5;   // Kd value that you have to change
...
const byte serialEn = 10;    // Connect UART output enable of LSA08 to pin 2
